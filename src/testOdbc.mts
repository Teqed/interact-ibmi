...
import { createUser } from './types.mjs';
...
export const copyUser = async (copyFromUser: string, newUser: string, userDescription: string) => {
	...
	let toUser: createUser = convertUserInterface(fromUser);
